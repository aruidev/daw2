    ...
    <nav class="header">
        <div class="header-inner">
            ...
            <div class="nav-items">
                ...
                <ul>
                    <li><a class="nav-item auth-btn secondary-btn ghost-btn" href="../../index.php" rel="noopener noreferrer">Login</a></li>
                    <li><a class="nav-item auth-btn primary-btn ghost-btn" href="../../index.php" rel="noopener noreferrer">Register</a></li>
                </ul>
            </div>
